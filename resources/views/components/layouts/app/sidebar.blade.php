    ...
    <body class="min-h-screen bg-white dark:bg-zinc-900">
        ...
        @if($user && $user->isAlumno())
            ...
            <div class="min-h-screen bg-neutral-50 dark:bg-zinc-900 relative overflow-hidden">
                {{-- Patrón claro (solo en modo light) --}}
                <div
                    class="pointer-events-none absolute inset-0 opacity-20 dark:opacity-0"
                    style="
                        background-image:
                    ...
                    "
                ></div>
                {{-- Patrón suave en modo dark (puntos claros) --}}
                <div
        ...
        @else
            {{-- Layout por defecto: sidebar + header móvil --}}
